...
(function()
{
  ...
  $(document).ready(function(){
    ...
    var ads = ["займи","купи","занять","источнике","заказ","закажи","Бот ПРОБИВЩИК","Шпион Бот","skillbox.ru","SkillFactory","Реклама","Карты мира из дерева","ШерлокБот"]; //Сюда пишем популярные триггеры
    startAnalysis(ads);
  })
})();
