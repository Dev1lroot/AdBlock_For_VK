...
(function()
{
  ...
  $(document).ready(function(){
    ...
    var ads = ["займи"," купи ","занять","источник","заказ","закажи","Бот ПРОБИВЩИК","Шпион Бот","skillbox.ru","SkillFactory","Реклама","Карты мира из дерева"," Бот ","Шерлокбот","Займербот"]; //Сюда пишем популярные триггеры
    startAnalysis(ads);
  })
})();
