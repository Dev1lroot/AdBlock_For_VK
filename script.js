...
(function()
{
  ...
  $(document).ready(function(){
    ...
    var ads = ["90% людей не умеют пользоваться деньгами","займи"," купи ","занять","источник","заказ","закажи","Бот ПРОБИВЩИК","Шпион Бот","skillbox.ru","SkillFactory","Реклама","Карты мира из дерева"," Бот ","Шерлокбот","Займербот"]; //Сюда пишем популярные триггеры
    startAnalysis(ads);
  })
})();
